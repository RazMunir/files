...
class AllStoriesV2 extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    return _AllStoriesV2();
  }
}

class _AllStoriesV2 extends State<AllStoriesV2>{
  ...
  _buildStoryItem(int index, String name, String image){
    return Container(
