...
class ChatScreen extends StatefulWidget {
  ...
  ChatScreen({this.groupName, this.groupMemberList});
                ...
                child: Container(
                  ...
                  child: Text(
                    widget.groupName.isEmpty
                        ? widget.groupMemberList[0].name +
                            "," +
                            widget.groupMemberList[1].name +
                            "+" +
                            "${widget.groupMemberList.length - 2}"
                        : widget.groupName,
