...
class OtpV3 extends StatefulWidget {
  final String email;
  ...
  const OtpV3({
    ...
    this.newEmail = "example@gmail.com",
    this.isGuestCheckOut,
  }) : super(key: key);

  @override
  _OtpV3 createState() => new _OtpV3();
}

class _OtpV3 extends State<OtpV3> with SingleTickerProviderStateMixin {
  // Constants
  final int time = 30;
